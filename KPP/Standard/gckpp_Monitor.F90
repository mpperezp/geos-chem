...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     ...
     'HPC52O2        ','VRP            ','ATOOH          ', & ! index 112 - 114
     'Br2            ','HC187          ','MOBA           ', & ! index 115 - 117
     'HONIT          ','DHMOB          ','IAP            ', & ! index 118 - 120
     'RIPB           ','BrSALC         ','MP             ', & ! index 121 - 123
     'ISNP           ','BrSALA         ','MAOP           ', & ! index 124 - 126
     'MRP            ','RIPA           ','RIPD           ', & ! index 127 - 129
     'EOH            ','ETHLN          ','N2O5           ', & ! index 130 - 132
     'ISNOHOO        ','MTPA           ','MTPO           ', & ! index 133 - 135
     'NPMN           ','C2H6           ','IONO2          ', & ! index 136 - 138
     'MOBAOO         ','DIBOO          ','IPMN           ', & ! index 139 - 141
     'LIMO           ','ISNOOB         ','INPN           ', & ! index 142 - 144
     'BrNO3          ','MACRNO2        ','ROH            ', & ! index 145 - 147
     'MONITS         ','I2             ','Cl2            ', & ! index 148 - 150
     'ISOPNB         ','H2             ','CH4            ', & ! index 151 - 153
     'MVKOO          ','GAOO           ','CH3CHOO        ', & ! index 154 - 156
     'MVKN           ','IEPOXOO        ','MGLYOO         ', & ! index 157 - 159
     'PRN1           ','MGLOO          ','MONITU         ', & ! index 160 - 162
     'A3O2           ','PROPNN         ','MAN2           ', & ! index 163 - 165
     'ISNOOA         ','PO2            ','ISOPNDO2       ', & ! index 166 - 168
     'HCOOH          ','B3O2           ','MACROO         ', & ! index 169 - 171
     'MAOPO2         ','R4N1           ','ISOP           ', & ! index 172 - 174
     'H2O2           ','ATO2           ','I              ', & ! index 175 - 177
     'RCO3           ','LIMO2          ','MACRN          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(60) :: SPC_NAMES_2 = (/ &
     'H              ','OLNN           ','OLND           ', & ! index 181 - 183
     'IO             ','KO2            ','HOBr           ', & ! index 184 - 186
     'ISOPNBO2       ','PIO2           ','HNO3           ', & ! index 187 - 189
     'GLYC           ','ISOPND         ','HOCl           ', & ! index 190 - 192
     'NMAO3          ','ACTA           ','VRO2           ', & ! index 193 - 195
     'CH2OO          ','HC5OO          ','ISN1           ', & ! index 196 - 198
     'ClNO3          ','MGLY           ','ACET           ', & ! index 199 - 201
     'HC5            ','GLYX           ','ETO2           ', & ! index 202 - 204
     'RIO2           ','MRO2           ','BrO            ', & ! index 205 - 207
     'R4O2           ','HAC            ','R4N2           ', & ! index 208 - 210
     'INO2           ','PRPE           ','RCHO           ', & ! index 211 - 213
     'MEK            ','MACR           ','ALD2           ', & ! index 214 - 216
     'CH2O           ','MVK            ','MCO3           ', & ! index 217 - 219
     'SO2            ','HBr            ','HCl            ', & ! index 220 - 222
     'NO2            ','CO             ','NO             ', & ! index 223 - 225
     'NO3            ','O              ','MO2            ', & ! index 226 - 228
     'OH             ','Cl             ','H2O            ', & ! index 229 - 231
     'O3             ','O1D            ','ClO            ', & ! index 232 - 234
     'Br             ','HO2            ','MOH            ', & ! index 235 - 237
     'N2             ','O2             ','RCOOH          ' /)
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     '     MAN2 + NO --> POx + 0.5 PCO + 0.5 PROPNN + 0.5 MGLY + 0.5 CH2O + 1.5 NO2 + 0.5 CO + 0.5 OH     ', & ! index 61
     ...
     '   ISNOOA + NO --> 0.04 ISN1OG + 0.96 POx + PCO + 0.96 PROPNN + NO2 + CO + HO2                      ', & ! index 67
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '    MAN2 + HO2 --> 0.075 PCO + 0.85 MAOP + 0.075 PROPNN + 0.075 MGLY + 0.075 CH2O + 0.925 NO2 + 0.07', & ! index 104
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '     GLYC + OH --> 0.361 CO2 + 0.505 PCO + 0.134 HCOOH + 0.134 GLYX + 0.732 CH2O + 0.505 CO + 0.227 ', & ! index 140
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '   MAN2 + MCO3 --> CO2 + 0.5 PCO + 0.5 PROPNN + 0.5 MGLY + 0.5 CH2O + 0.5 NO2 + 0.5 CO + MO2 + 0.5 H', & ! index 215
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_9 = (/ &
     ...
     '     HCl + O1D --> 0.67 LOx + 0.24 H + 0.09 HCl + 0.09 O + 0.67 OH + 0.67 Cl + 0.24 ClO             ', & ! index 299
     '     HBr + O1D --> 0.65 LOx + 0.15 H + 0.15 BrO + 0.2 HBr + 0.2 O + 0.65 OH + 0.65 Br               ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_10 = (/ &
     ...
     '  HCFC22 + O1D --> 0.17 LOx + 0.28 HCFC22 + 0.28 O + 0.17 Cl + 0.55 ClO                             ', & ! index 306
     '   CFC11 + O1D --> 0.12 CFC11 + 0.12 O + 1.76 Cl + 0.88 ClO                                         ', & ! index 307
     '   CFC12 + O1D --> 0.14 CFC12 + 0.14 O + 0.86 Cl + 0.86 ClO                                         ', & ! index 308
     '   H1211 + O1D --> 0.36 H1211 + 0.31 BrO + 0.36 O + 0.31 Cl + 0.33 ClO + 0.33 Br                    ', & ! index 309
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_14 = (/ &
     ...
     '    DIBOO + NO --> POx + 0.52 GLYC + 0.52 MGLY + 0.48 GLYX + 0.48 HAC + NO2 + HO2                   ', & ! index 428
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_16 = (/ &
     ...
     '   LIMO2 + NO3 --> LOx + 0.385 PRPE + 0.615 MACR + 0.385 CH2O + NO2 + HO2                           ', & ! index 506
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_17 = (/ &
     ...
     '   OLNN + OLND --> 0.5 POx + 1.05 MONITS + 0.45 MONITU + 0.64 RCHO + 0.149 MEK + 0.202 CH2O + 0.5 NO', & ! index 519
     ...
     '  DHPCARP + NO --> POx + MGLY + GLYX + NO2 + OH                                                     ', & ! index 531
     '  HPC52O2 + NO --> POx + MGLY + GLYX + NO2 + OH                                                     ', & ! index 532
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_20 = (/ &
     ...
     '           NO2 --> NO + O                                                                           ', & ! index 607
     '          H2O2 --> 2 OH                                                                             ', & ! index 608
     '            MP --> CH2O + OH + HO2                                                                  ', & ! index 609
     '          CH2O --> PCO + H + CO + HO2                                                               ', & ! index 610
     '          CH2O --> PCO + H2 + CO                                                                    ', & ! index 611
     ...
     '           PAN --> 0.3 POx + 0.7 MCO3 + 0.7 NO2 + 0.3 NO3 + 0.3 MO2                                 ', & ! index 621
     ...
     '          GLYC --> PCO + 0.9 CH2O + CO + 0.07 OH + 1.73 HO2 + 0.1 MOH                               ', & ! index 626
     '          GLYX --> 2 PCO + 2 CO + 2 HO2                                                             ', & ! index 627
     '          GLYX --> 2 PCO + H2 + 2 CO                                                                ', & ! index 628
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_21 = (/ &
     ...
     '          INPN --> RCHO + NO2 + OH + HO2                                                            ', & ! index 636
     '          PRPN --> RCHO + NO2 + OH + HO2                                                            ', & ! index 637
     '           ETP --> ALD2 + OH + HO2                                                                  ', & ! index 638
     '          RA3P --> RCHO + OH + HO2                                                                  ', & ! index 639
     '          RB3P --> ACET + OH + HO2                                                                  ', & ! index 640
     '           R4P --> RCHO + OH + HO2                                                                  ', & ! index 641
     '            PP --> ALD2 + CH2O + OH + HO2                                                           ', & ! index 642
     '            RP --> ALD2 + OH + HO2                                                                  ', & ! index 643
     '          RIPA --> 0.005 LVOC + 0.275 HC5 + 0.285 MACR + 0.71 CH2O + 0.425 MVK + 0.985 OH + 0.985 HO', & ! index 644
     '          RIPB --> 0.005 LVOC + 0.275 HC5 + 0.285 MACR + 0.71 CH2O + 0.425 MVK + 0.985 OH + 0.985 HO', & ! index 645
     '          RIPD --> 0.005 LVOC + 0.275 HC5 + 0.285 MACR + 0.71 CH2O + 0.425 MVK + 0.985 OH + 0.985 HO', & ! index 646
     '           IAP --> 0.67 PCO + 0.19 H2 + 0.26 GLYC + 0.58 MGLY + 0.36 HAC + 0.67 CO + OH + HO2       ', & ! index 647
     '          ISNP --> RCHO + NO2 + OH + HO2                                                            ', & ! index 648
     '           VRP --> 0.7 GLYC + 0.3 MGLY + 0.3 CH2O + 0.7 MCO3 + OH + 0.3 HO2                         ', & ! index 649
     '           MRP --> 0.5 PCO + HAC + 0.5 CH2O + 0.5 CO + OH + HO2                                     ', & ! index 650
     ...
     '         MACRN --> 0.5 PCO + MGLY + HAC + 0.5 CH2O + NO2 + 0.5 CO + HO2                             ', & ! index 654
